...
class OrganizationResourceIT {
    ...
    void checkNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = this.organizationRepository.findAll().size();
        // set the field null
    ...
    void getAllOrganizations() throws Exception {
        ...
        this.restOrganizationMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(this.organization.getId().intValue())))
    ...
    void getOrganization() throws Exception {
        ...
        this.restOrganizationMockMvc
            .perform(get(ENTITY_API_URL_ID, this.organization.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(this.organization.getId().intValue()))
    ...
    void getNonExistingOrganization() throws Exception {
        // Get the organization
        this.restOrganizationMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    void putNewOrganization() throws Exception {
        ...
        int databaseSizeBeforeUpdate = this.organizationRepository.findAll().size();

        // Update the organization
        Organization updatedOrganization = this.organizationRepository.findById(this.organization.getId()).get();
        // Disconnect from session so that the updates on updatedOrganization are not directly saved in db
        this.em.detach(updatedOrganization);
        updatedOrganization.name(UPDATED_NAME).mail(UPDATED_MAIL).phone(UPDATED_PHONE).ownerId(UPDATED_OWNER_ID).active(UPDATED_ACTIVE);
    ...
    void partialUpdateOrganizationWithPatch() throws Exception {
        ...
        partialUpdatedOrganization.name(UPDATED_NAME).ownerId(UPDATED_OWNER_ID).active(UPDATED_ACTIVE);
    ...
    void deleteOrganization() throws Exception {
        ...
        this.restOrganizationMockMvc
            .perform(delete(ENTITY_API_URL_ID, this.organization.getId()).accept(MediaType.APPLICATION_JSON))
